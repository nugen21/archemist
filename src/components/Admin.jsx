            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-1.5 opacity-80">
                  ...
                  <div className="bg-[#0b0c0b] border border-gray-800 rounded-xl px-4 py-3 text-copper text-base font-black flex items-center justify-between">
                    <div className="flex items-center gap-2">
                       <span>{(parseFloat(String(formData.price || '0').replace(/,/g, '')) * 0.0001 * (formData.recommended ? 1.1 : 1)).toFixed(1)} XP</span>
                          ...
                          <div key={catIdx} className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {cat.items.map((item, itemIdx) => {
                                ...
                                const config = FLAVOR_CONFIG[item] || FLAVOR_CONFIG[item.replace(/\s+/g, '')];
                                ...
                                return (
                                  <button
                                    ...
                                    className={`px-3 py-2 rounded-lg text-[10px] font-bold text-left transition-all border ${
                                      isSelected 
                                        ? 'shadow-[0_0_15px_rgba(0,0,0,0.3)] brightness-110' 
              ...
              <div className="md:col-span-2 lg:col-span-3 pb-6 border-b border-gray-800">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-8">
                  <RatingSlider label="향 (Flavor)" name="flavor" value={formData.flavor} onChange={handleChange} />
