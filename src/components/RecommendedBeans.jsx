            ...
            >
              ...
              <div className="mb-4 border-b border-copper/10 pb-4">
                ...
                <div className="flex justify-between items-center mb-4 border-b border-copper/10 pb-2">
                  ...
                  {bean.category !== 'beverage' && (
                    <div className="flex items-center gap-2 bg-gradient-to-br from-amber-500/15 to-yellow-500/5 border border-amber-500/20 px-3 py-2 rounded-xl backdrop-blur-sm group-hover:scale-105 transition-all relative">
